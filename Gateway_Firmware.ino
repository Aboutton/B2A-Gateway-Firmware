...
void setup() {
  ...
  // Copy config values
  config.can_bitrate = gw_config.can1_bitrate;
  config.can1_enabled = gw_config.can1_enabled;
  config.can2_enabled = gw_config.can2_enabled;
  config.can1_term = gw_config.can1_term;
  config.can2_term = gw_config.can2_term;
  ...
  Serial.println("WiFi: " + wifi_ssid + " / " + String(gw_config.wifi_password));
